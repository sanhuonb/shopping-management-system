...
public class GoodsPage extends ScannerChoice {
     ...
     * 1.添加商品界面
     */
    public static void addGoodsPage() throws InterruptedException {
        System.out.println("\t正在执行添加商品操作\n");
        System.out.println("\n请输入添加商品-名称");
        String goodsName = ScannerInfoString();
        System.out.println("\n请输入添加商品-价格");
        double goodsPrice = ScanerInfo();
        System.out.println("\n请输入添加商品-数量");
     ...
     * 2.更改商品界面
     */
    public static void updateGoodsPage() throws InterruptedException {
     ...
     * 3.删除商品界面
     */
    public static void deleteGoodsPage() throws InterruptedException {
     ...
     * 5. 查询商品界面
     */
    public static void queryGoodsPage() throws InterruptedException {
     ...
     * 4. 展示所有商品页面
     */
    public static void displayGoodsPage() throws InterruptedException {
